// DOM Elements for Articles page
...
function filterArticles() {
    ...
    articles.forEach(article => {
        ...
        const matchesCategory = category === '' || article.querySelector('.article-meta').textContent.toLowerCase().includes(category);
        const matchesSearch = title.includes(searchTerm) || excerpt.includes(searchTerm) || author.includes(searchTerm);
